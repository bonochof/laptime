...
(function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MainComponent_render_2;

      return (Opal.defn(self, '$render', TMP_MainComponent_render_2 = function $$render() {
        var TMP_1, self = this;

        return $send(self, 'o', ["div"], (TMP_1 = function(){var self = TMP_1.$$s || this;

        return self.$o("h1", "HELLO")}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
      }, TMP_MainComponent_render_2.$$arity = 0), nil) && 'render'
